<template>
    <div id="cart" class="flex no-underline hover:text-black">        
            <div class="relative flex items-center font-bold focus:outline-none fill-current hover:text-black" @mouseover="isOpen = true">
                ...
                <div class="absolute w-72 bg-gray-100 top-8 right-0 shadow z-50" v-show="isOpen && hasProducts" @mouseleave="isOpen = false">
